...
class Client(object):
    ...
    *KAc*  : `KAS` --
    ...
    def set_scenario(dimension, valuesize, keysize, threshold, nclients, publicparam):
        ...
        Client.VE = VES(keysize // 2, 2*(nclients - 1) - 1, valuesize, dimension)
    ...
    def online_construct(self, eshares, z_tau=0):
        ...
        **Returns**: 
        ...
        if self.U != self.Ualive:
            ...
            if dropshares:
                Yzeroshare = Client.TJL.ShareProtect(Client.pp, dropshares, self.step, z_tau, self.user, self.Ualive)
